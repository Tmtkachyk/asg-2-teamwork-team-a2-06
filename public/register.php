...
<body>
  ...
  <form method="post" class="theForm" action="regitserAction.php">
    ...
    <div class="logContainer">
      ...
      <input type="password" class="password" placeholder="Enter Password" name="passwordRegister" required minlength="8">
      <br>

      <label><b>Confirm password</b></label>
      <input type="password" class="passwordConfirm" placeholder="Re-enter Password" name="psw_confirm" required minlength="8">
      <br>
